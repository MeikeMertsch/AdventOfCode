(ns christmas.chr18.day23-test
 (:require [christmas.chr18.day23 :as chr]
...
(def file (get-file "resources/chr18/Input23"))
(def file-b (get-sorted-file "resources/chr18/Input23b"))
(def real-file (get-sorted-file "resources/chr18/Input23real"))
