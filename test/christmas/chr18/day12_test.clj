(ns christmas.chr18.day12-test
 (:require [christmas.chr18.day12 :as chr]
...
(def file (get-file "resources/chr18/Input12"))
(def realFile (get-file "resources/chr18/Input12real"))
