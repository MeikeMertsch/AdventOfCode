(ns christmas.chr18.day07-test
  (:require [christmas.chr18.day07 :as chr]
...
(def realFile (getFile "resources/chr18/Input07real"))
(def file (getFile "resources/chr18/Input07"))
