(ns christmas.chr18.day13-test
 (:require [christmas.chr18.day13 :as chr]
...
(def file (get-file "resources/chr18/Input13"))
(def realFile (get-file "resources/chr18/Input13real"))
