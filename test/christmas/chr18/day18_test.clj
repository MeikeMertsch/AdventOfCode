(ns christmas.chr18.day18-test
 (:require [christmas.chr18.day18 :as chr]
...
(def init-file (get-file "resources/chr18/Input18"))
(def m10-file (get-file "resources/chr18/Input18b"))
(def m01-file (get-file "resources/chr18/Input18c"))
(def m02-file (get-file "resources/chr18/Input18d"))
(def real-file (get-file "resources/chr18/Input18real"))
