(ns christmas.chr18.day08-test
  (:require [christmas.chr18.day08 :as chr]
...
(def file (getFile "resources/chr18/Input08"))
(def fileb (getFile "resources/chr18/Input08b"))  ; I invented that one
(def realFile (getFile "resources/chr18/Input08real"))
